...
\begin{center}
  \begin{tikzpicture}
    ...
    \node[coordinate,pin={[pin distance=3cm] 20:{Threaded connection}}] at (0.2,0.2) {};
...
\begin{center}
  \begin{tikzpicture}
    ...
    \node[coordinate,pin={[pin distance=1cm] 70:{Threaded connection}}] at (-0.4,1.8) {};
...
\begin{center}
  \begin{tikzpicture}
    ...
    \node[coordinate,pin=170:{Threaded connection}] at (-1.4,-0.5) {};
