...
\label{sec:orgca8c9f6}
\begin{frame}[label={sec:org6022261}]{First-order system example: A tank}
\begin{center}
...
\begin{frame}[label={sec:orgde4504a}]{First-order system example: A tank}
\begin{center}
...
\begin{frame}[label={sec:org42acba5}]{Intuition}
...
\begin{frame}[label={sec:orge1d1a40}]{Deviation variables}
\begin{center}
...
\begin{frame}[label={sec:orgc3faefa}]{Intuition}
...
\begin{frame}[label={sec:org237f19c}]{Fitting a first-order model}
...
\begin{frame}[label={sec:orgbb67976}]{Fitting a first-order model}
Assuming a plant model of first-order with time-constant \(T\)
\[  \quad \textcolor{green!50!black}{Y(s)} = \frac{K}{sT + 1}\textcolor{blue!80!black}{U(s)} \quad \overset{U(s) = \frac{u_f}{s}}{\Longrightarrow} \quad \textcolor{green!50!black}{y(t)} = u_f K\big( 1 - \mathrm{e}^{-\frac{t}{T}}\big)u_H(t)\]
\def\Tcnst{3}
\def\tdelay{0.0}
...
\section{CSTR}
\label{sec:org63c92d8}

\begin{frame}[label={sec:org86f683c}]{A Continuous Stirred Tank Reactor}
\begin{center}
\includegraphics[height=0.8\textheight]{../../figures/stirred_tank_heat_exchange}
\end{center}
\end{frame}

\begin{frame}[label={sec:org315c48d}]{A Continuous Stirred Tank Reactor}
\begin{columns}
...
\begin{frame}[label={sec:orgca7623b}]{A Continuous Stirred Tank Reactor}
\begin{center}
...
\begin{frame}[label={sec:orgcb60eff}]{Intuition}
\begin{center}
...
\label{sec:org4da89d4}
\begin{frame}[label={sec:orgd4c7560}]{Fitting first-order model with delay}
...
\begin{frame}[label={sec:orgb4c2701}]{Fitting first-order model with delay}
Assuming a plant model of first-order with time constant \(T\) and delay \(\tau\)
\[  \quad \textcolor{green!50!black}{Y(s)} = \frac{K\mathrm{e}^{-s\tau}}{sT + 1}\textcolor{blue!80!black}{U(s)} \quad \overset{U(s) = \frac{u_f}{s}}{\Longrightarrow} \quad \textcolor{green!50!black}{y(t)} = u_f K\big( 1 - \mathrm{e}^{-\frac{t-\tau}{T}}\big)u_H(t-\tau)\]
\def\Tcnst{3}
\def\tdelay{0.6}
...
\begin{frame}[label={sec:orgd2f9e32}]{First-order model with delay - example}
...
\begin{frame}[label={sec:org01be687}]{First-order model with delay - example}
\[  \quad Y(s) = \frac{K\mathrm{e}^{-s\tau}}{sT + 1}U(s) \quad \overset{U(s) = \frac{u_f}{s}}{\Longrightarrow} \quad y(t) = u_f K\big( 1 - \mathrm{e}^{-\frac{t-\tau}{T}}\big)u_s(t-\tau)\]
\def\Tcnst{2.1}
\def\tdelay{1}
\def\ggain{2}
...
\begin{frame}[label={sec:org9d59a42}]{First-order model with delay - example}
\[  \quad Y(s) = \frac{K\mathrm{e}^{-s\tau}}{sT + 1}U(s) \quad \overset{U(s) = \frac{u_f}{s}}{\Longrightarrow} \quad y(t) = u_f K\big( 1 - \mathrm{e}^{-\frac{t-\tau}{T}}\big)u_s(t-\tau)\]
\def\Tcnst{2.1}
\def\tdelay{1}
\def\ggain{2}
...
\begin{frame}[label={sec:orgd6024cf}]{First-order model with delay - example}
\[  \quad Y(s) = \frac{K\mathrm{e}^{-s\tau}}{sT + 1}U(s) \quad \overset{U(s) = \frac{u_f}{s}}{\Longrightarrow} \quad y(t) = u_f K\big( 1 - \mathrm{e}^{-\frac{t-\tau}{T}}\big)u_s(t-\tau)\]
\def\Tcnst{2.1}
\def\tdelay{1}
\def\ggain{2}
...
\begin{frame}[label={sec:org5ee71dd}]{First-order model with delay - example}
\[  \quad Y(s) = \frac{K\mathrm{e}^{-s\tau}}{sT + 1}U(s) \quad \overset{U(s) = \frac{u_f}{s}}{\Longrightarrow} \quad y(t) = u_f K\big( 1 - \mathrm{e}^{-\frac{t-\tau}{T}}\big)u_s(t-\tau)\]
\def\Tcnst{2.1}
\def\tdelay{1}
\def\ggain{2}
