...
\node[circle, draw, left of=h2, node distance=1cm, align=center, inner sep=1pt] (LE) {\sf LE\\101B};
\node[circle, draw, left of=h1, node distance=1cm, align=center, inner sep=1pt] (LE1) {\sf LE\\101A};
\node[circle, draw,  left of=LE, node distance=7cm, align=center, inner sep=1pt] (LC) {\sf LC\\101};
\node[circle, draw,  node distance=7cm, align=center, inner sep=1pt] (FE) at (8.3cm, -5cm) {\sf FE\\101};
