...
\begin{document}
\begin{circuitikz}
\draw (0,0) to[push button, label=$a$,o-] (2.5,0) to[push button, label=$a$, -o] (4,0);

\draw (0.4,0) to[short] (0.4, -1) to[push button, label=$b$] (2.1,-1)
to[short] (2.1, 0);
\draw[thin, dashed] (1.2,0.28) to (3.4, 0.28);
