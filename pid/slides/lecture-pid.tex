...
\label{sec:orgb83a172}
\begin{frame}[label={sec:org0c677ab}]{Second-order models}
\end{frame}
\begin{frame}[label={sec:org867841d}]{Two first-order models in series}
\begin{center}
\begin{tikzpicture}
...
\begin{frame}[label={sec:org9159ee7}]{Fitting second-order critically-damped model}
...
\label{sec:orgc9a21be}
\begin{frame}[label={sec:org88cf838}]{Feedback control}
   \begin{center}
   \begin{tikzpicture}[node distance=22mm, block/.style={rectangle, draw, minimum width=15mm}, sumnode/.style={circle, draw, inner sep=2pt}]
  { 
  \node[coordinate] (input) {};
...
\begin{frame}[label={sec:org11b01f8}]{The PID controller}
\begin{center}
...
\begin{frame}[label={sec:org9cfe9ef}]{The PID - Parallel form}
\definecolor{ppc}{rgb}{0.1,0.1,0.6}
\definecolor{iic}{rgb}{0.6,0.1,0.1}
\definecolor{ddc}{rgb}{0.1,0.6,0.1}
...
\begin{frame}[label={sec:orga3b87f0}]{The PID - Parallel form, modified D-part}
\definecolor{ppc}{rgb}{0.1,0.1,0.6}
\definecolor{iic}{rgb}{0.6,0.1,0.1}
\definecolor{ddc}{rgb}{0.1,0.6,0.1}
...
\begin{frame}[label={sec:org67caeb1}]{The PID - Parallel form}
\begin{center}
...
\begin{frame}[label={sec:org66504ff}]{The PID - Parallel form, solution}
\end{frame}
\begin{frame}[label={sec:orgacb2810}]{The PID - Parallel form, solution}
\(u(t) = k_c\Big( \textcolor{ppc}{e(t)} + \textcolor{iic}{\overbrace{\frac{1}{\tau_i} \int_0^{t} e(\xi) d\xi}^{u_I(t)}} + \textcolor{ddc}{ \underbrace{\tau_d \frac{d}{dt} \big(-y(t)\big)}_{u_D(t)}} \Big)\)
   \begin{center}
   \def\TT{1}
   \begin{tikzpicture}
...
\begin{frame}[label={sec:orgf12fec4}]{The PID - practical form}
\definecolor{ppc}{rgb}{0.1,0.1,0.6}
\definecolor{iic}{rgb}{0.6,0.1,0.1}
...
\label{sec:org9f3779a}
\begin{frame}[label={sec:org06c05bc}]{PID tuning}
\end{frame}
\begin{frame}[label={sec:orgb4afb6f}]{Method by Smith \& Corripio using table by Ziegler-Nichols}
...
\label{sec:org809eb76}

\begin{frame}[label={sec:org07efe71}]{Analytical PID tuning}
\end{frame}
\begin{frame}[label={sec:org4df3a8c}]{Analytical PID tuning}
   \begin{center}
   \begin{tikzpicture}[node distance=22mm, block/.style={rectangle, draw, minimum width=15mm}, sumnode/.style={circle, draw, inner sep=2pt}]
  { 
  \node[coordinate] (input) {};
...
\begin{frame}[label={sec:org5aa30fb}]{Analytical PID tuning - Solution}
\end{frame}
\begin{frame}[label={sec:orgc76ca52}]{Analytical PID tuning - Solution}
...
\begin{frame}[label={sec:org4c7f8da}]{Analytic PID tuning - first-order with delay}
   \begin{center}
   \begin{tikzpicture}[node distance=22mm, block/.style={rectangle, draw, minimum width=15mm}, sumnode/.style={circle, draw, inner sep=2pt}]
  { 
  \node[coordinate] (input) {};
...
\begin{frame}[label={sec:org47c1e4e}]{SIMC-PID tuning rule}
